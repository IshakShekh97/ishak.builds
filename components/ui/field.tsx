...
function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: standard shadcn layout requires div container
    <div
      role="group"
      data-slot="field"
  ...
  const content = useMemo(() => {
    ...
    return (
      <ul className="ml-4 flex list-disc flex-col gap-1">
        {uniqueErrors.map(
          (error, index) =>
            // biome-ignore lint/suspicious/noArrayIndexKey: list is static and not subject to re-ordering
